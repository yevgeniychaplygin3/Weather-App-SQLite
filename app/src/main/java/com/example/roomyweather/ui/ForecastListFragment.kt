...
//                supportActionBar?.title = forecast.city.name
    ...
    override fun onResume() {
        ...
        if (city != null) {
            val savedCity = ForecastRoomEntity(city, System.currentTimeMillis())
    ...
    private fun onForecastItemClick(forecastPeriod: ForecastPeriod) {
        ...
        Log.d("ForecastListFragment", "forecastCity: $forecastCity")
        val directions = ForecastListFragmentDirections.navigateToForecastDetail(forecastPeriod, forecastCity!!)
